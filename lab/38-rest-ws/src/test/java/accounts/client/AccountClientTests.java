...
//	@Disabled
	public void addAndDeleteBeneficiary() {
		...
		final String beneficiaryName = "David";
		final URI newBeneficiaryLocation = restTemplate.postForLocation(
				BASE_URL + "/accounts/{accountId}/beneficiaries", beneficiaryName, accountId);
