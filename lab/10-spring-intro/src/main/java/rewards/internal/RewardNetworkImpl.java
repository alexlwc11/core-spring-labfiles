...
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining)
	{
		...
		final Restaurant restaurant = restaurantRepository.findByMerchantNumber(dining.getMerchantNumber());
		final MonetaryAmount benefit = restaurant.calculateBenefitFor(account, dining);
		final AccountContribution contribution = account.makeContribution(benefit);
